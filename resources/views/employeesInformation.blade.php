...
<div class="col-md-4">
    <div class="card user-card">
        ...
        <div class="card-block">
            ...
            <h6 class="f-w-600 m-t-25 m-b-10">{{$user->first_name}} {{$user->last_name}}</h6>
            <p class="text-muted"> {{$user->date_birth}} | {{$user->hobby}}</p>
            <hr>
            ...
            <div class="bg-c-green counter-block m-t-10 p-20">
                <div class="row">
                    <div class="col-4">
                        ...
                        <p> عدد الانشطة الفردية :{{count(\App\Models\Activity::where('user_id',$user->id)->get())}} </p>
                    </div>
                    <div class="col-4">
                        <i class="fa fa-user"></i>
                        <p>عدد الانشظة الجماعية : {{count(\App\Models\Group_Activity_User::where('user_id',$user->id)->get())}} </p>
                    </div>
                    <div class="col-4">
